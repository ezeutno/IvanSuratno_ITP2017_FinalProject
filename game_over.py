...
class Game_over:
	def __init__(self,screen,stats):
		...
		self.msg0_image_rect.center = (self.rect.centerx,self.rect.centery - int(self.screen_rect.height/15)*2)
		...
		self.msg1_image_rect.center = (self.rect.centerx,self.rect.centery - int(self.screen_rect.height/15))
		...
		self.msg3_image_rect.center = (self.rect.centerx,self.rect.centery + int(self.screen_rect.height/15))
		...
		self.msg4_image_rect.center = (self.rect.centerx,self.rect.centery + int(self.screen_rect.height/15)*2)
